...
extension TradeManager {
    ...
    private static func routerAddress(chain: Chain) throws -> Address {
        ...
        case .komerco: return try Address(hex: "0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff")
    ...
    private static func factoryAddressString(chain: Chain) throws -> String {
        ...
        case .komerco: return "0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32"
    ...
    private static func initCodeHashString(chain: Chain) throws -> String {
        ...
        case .komerco: return "0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f"
